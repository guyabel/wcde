...
The [vignette](https://guyabel.github.io/wcde/articles/intro.html) provides many more examples on how to use the package to download data and produce plots from the Wittgenstein Centre Human Capital Data Explorer.
